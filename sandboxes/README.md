...
| [008-local-legal-smell-engine](008-local-legal-smell-engine/README.md) | Extract the five preserved Sandbox 002 Stage 006 detector families into a generic, local-first, open-source-friendly Python engine with stable evidence contracts and optional adapters; Stage 003 adds a separate twenty-smell model benchmark. | Active; Stages 001–002 implemented, Stage 003 benchmark in progress |
