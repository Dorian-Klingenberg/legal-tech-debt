...
- The current work is sandbox research, proof-of-concept experimentation, and production-aligned portfolio development; it is not production infrastructure work.
...
- Sandboxes 001-004 are complete and preserved. Their historical handoffs record point-in-time states; they are not current resume instructions.
- The current primary lane, secondary review gate, exact evidence counts, and latest handoff are maintained in `README.md` and `AGENT_CONTEXT.json`.
